...
/// <summary>
/// Provides asynchronous data retrieval for filtering (non-generic, items as <see cref="object"/>).
/// </summary>
public interface IAsyncDataProvider
{
    ...
    Task<PagedResult<object>> FetchDataAsync(IFilterContext context, CancellationToken cancellationToken = default);
