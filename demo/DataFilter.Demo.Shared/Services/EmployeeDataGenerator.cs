...
{
    private static readonly string[] depts = new[] { "IT", "HR", "Sales", "Marketing", "Engineering" };
    private static readonly string[] countries = new[] { "France", "USA", "UK", "Germany", "Japan" };
    private static readonly string[] names = new[] { "Alice", "Bob", "Charlie", "David", "Eva", "Frank", "Grace", "Henry", "Ivy", "Jack" };
    private static readonly string[] pooledNames;
